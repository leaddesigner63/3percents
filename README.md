...
Бот показывает все сообщения из базы контента по одному на экран в порядке публикации и использует инлайн‑клавиатуру для навигации.
...
Бот при запуске читает уже сохранённые посты из файла и показывает их по одному в порядке публикации.
